        ...
        <div id="login-box">
            ...
            <el-form v-show="formType == 'login'" ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
                ...
                <div class="flex-bar">
                    ...
                    <el-button type="text" @click="handleFind">忘记密码</el-button>
                </div>
            ...
            <el-form v-show="formType == 'reset'" ref="resetForm" :model="resetForm" :rules="resetRules" class="login-form" auto-complete="on" label-position="left">
                ...
                <div>
                    <el-form-item prop="username">
                        <el-input ref="name" v-model="resetForm.username" placeholder="用户名" type="text" tabindex="1" autocomplete="on">
                            <template #prefix>
                                <svg-icon name="user" />
                            </template>
                        </el-input>
    ...
    methods: {
        ...
        autoLogin() {
            ...
            if (username && password) {
                Object.assign(this.loginForm, {username, password})
                // this.handleLogin()
            }
        }
    }
