        ...
        <el-dropdown class="user-container" @command="userCommand">
            <div class="user-wrapper">
                <el-avatar size="medium">
                    <i v-if="!$store.state.user.avatar" class="el-icon-user-solid" />
                    <img v-else :src="$store.state.user.avatar" alt="">
                </el-avatar>
...
export default {
    ...
    methods: {
        ...
        pro() {
            window.open(`https://hooray.${location.origin.includes('gitee') ? 'gitee' : 'github'}.io/admin/vue3/pro`, 'top')
        }
    }
}
</script>
